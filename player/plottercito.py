...
axs[0,0].plot(t, puck_x, marker='o', color='g')
...
axs[1,0].plot(t, paddle_x, marker='o', color='b')
...
axs[0,1].plot(t, puck_y, marker='o', color='g')
...
axs[1,1].plot(t, paddle_y, marker='o', color='b')
...
sc_puck = axs[0,2].scatter(-puck_y, puck_x, c=t, cmap='Wistia', marker='o')
...
axs[0,2].axvline(x=-middle_line, color='red', linestyle='-')
axs[0,2].axvline(x=-mirror_line, color='red', linestyle='--')
axs[0,2].axvline(x=-base_right, color='red', linestyle='-')
cbar = fig.colorbar(sc_puck, ax=axs[0,2])
cbar.set_label('t')

sc_paddle = axs[1,2].scatter(-paddle_y, paddle_x, c=t, cmap='Wistia', marker='o')
...
axs[1,2].axvline(x=-middle_line, color='red', linestyle='-')
axs[1,2].axvline(x=-mirror_line, color='red', linestyle='--')
axs[1,2].axvline(x=-base_right, color='red', linestyle='-')
