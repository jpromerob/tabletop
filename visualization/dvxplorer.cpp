...
int main(void) {
	...
	handle.configSet(CAER_HOST_CONFIG_PACKETS,CAER_HOST_CONFIG_PACKETS_MAX_CONTAINER_INTERVAL, 500);
	// uint32_t toto = handle.configGet(CAER_HOST_CONFIG_DATAEXCHANGE, CAER_HOST_CONFIG_DATAEXCHANGE_BLOCKING);
	// printf("DVX_USB:DVX_USB_EARLY_PACKET_DELAY -->  %d\n", toto);
