...
if __name__ == '__main__':
    ...
    spif_lsc = p.external_devices.SPIFLiveSpikesConnection([IN_POP_LABEL], SPIF_IP, SPIF_PORT)
    spif_lsc.add_receive_callback(IN_POP_LABEL, forward_out_data)
    ...
    p.external_devices.activate_live_output_to(p_spif_virtual_a, spif_out_output)
