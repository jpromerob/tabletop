...
if __name__ == '__main__':
    ...
    p.setup(timestep=1.0, n_boards_required=3, cfg_file=CFG_FILE)
    ...
    middle_pop = p.Population(WIDTH * HEIGHT, celltype(**cell_params), label="motor_neurons")
    ...
    synapse_type = p.StaticSynapse(weight=100.0, delay=0.0)
    con_move = p.Projection(p_spif_virtual_a, middle_pop, cell_conn, synapse_type)
