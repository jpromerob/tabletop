...
if __name__ == '__main__':
    ...
    s_act_neuron = p.Population(1, celltype(**a_cell_params), label="s_act_neuron")
    ...
    p.Projection(s_cnn_pop, s_act_neuron, p.AllToAllConnector(), receptor_type='excitatory', synapse_type=act_syn)
    ...
    a_cnn_pop = p.Population(OUT_WIDTH * OUT_HEIGHT, celltype(**f_cell_params),
